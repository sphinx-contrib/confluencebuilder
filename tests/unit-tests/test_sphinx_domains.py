...
class TestConfluenceSphinxDomains(unittest.TestCase):
    ...
    def test_storage_sphinx_domain_c(self):
        out_dir = build_sphinx(
            self.dataset, config=self.config, filenames=["domains-c"]
        )
    ...
    def test_storage_sphinx_domain_cpp(self):
        out_dir = build_sphinx(
            self.dataset, config=self.config, filenames=["domains-cpp"]
        )
    ...
    def test_storage_sphinx_domain_js(self):
        out_dir = build_sphinx(
            self.dataset, config=self.config, filenames=["domains-js"]
        )
    ...
    def test_storage_sphinx_domain_py(self):
        out_dir = build_sphinx(
            self.dataset, config=self.config, filenames=["domains-py"]
        )
    ...
    def test_storage_sphinx_domain_rst(self):
        out_dir = build_sphinx(
            self.dataset, config=self.config, filenames=["domains-rst"]
        )
