...
from sphinxcontrib.confluencebuilder.directives import (
    ConfluenceExpandDirective,
    ConfluenceMetadataDirective,
    JiraDirective,
    JiraIssueDirective,
)
from sphinxcontrib.confluencebuilder.logger import ConfluenceLogger
from sphinxcontrib.confluencebuilder.nodes import confluence_metadata, jira, jira_issue
...
def setup(app):
    ...
    if imgmath is not None and "sphinx.ext.imgmath" not in app.config.extensions:
